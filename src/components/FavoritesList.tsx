...
export function FavoritesList({ favorites, onRemove, onSelect }: FavoritesListProps) {
  return (
    <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-xl p-4 text-white">
      ...
      {favorites.length === 0 ? (
        ...
        <div className="space-y-2">
          {favorites.map((fav) => (
            <div key={fav.char_name} className="flex items-center justify-between bg-black/20 p-2 rounded-lg hover:bg-black/40 transition-colors">
              <button 
